...
complete -c vinput -n "__fish_seen_subcommand_from scene; and __fish_seen_subcommand_from add edit e" -l show-raw -a "true false" -d "Include raw ASR transcript in candidate options (true/false)"
